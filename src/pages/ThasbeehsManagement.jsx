...
import { Plus, Pencil, Trash2, X, Save, FileText, AlignLeft, Eye, Search, RotateCcw } from 'lucide-react';
...
const EMPTY = { title: '', arabic_text: '', count: '', isCountless: false, malayalam: '', english: '', urdu: '', description: { ...EMPTY_DESC }, isQuranicFont: false };
