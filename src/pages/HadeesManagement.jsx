...
import { Plus, Pencil, Trash2, X, BookOpen, Save, AlignLeft, Eye, Search, Tag, ChevronDown, User } from 'lucide-react';
...
const EMPTY = { arabic_text: '', english: '', malayalam: '', urdu: '', category: '', reported_by: '', isQuranicFont: false };
...
function Modal({ item, categories, onClose, onSave }) {
  ...
  const [form, setForm] = useState(
    item
      ? { ...item, category: item.category?._id || item.category || '', isQuranicFont: item.isQuranicFont || false }
      : EMPTY
  );
